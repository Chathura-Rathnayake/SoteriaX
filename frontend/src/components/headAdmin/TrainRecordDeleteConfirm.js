      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Your are going to delete the training session "<strong>{dataConfirm.title}</strong> "
          </DialogContentText>
          <DialogContentText id="alert-dialog-description">
             scheduled  "<strong>{dataConfirm.date}</strong>" at "<strong>{dataConfirm.startTime}</strong>"
          </DialogContentText>
        </DialogContent>
        <DialogActions>
